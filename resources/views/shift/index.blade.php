...
<div class="sh-card-grid">
    @foreach ($shifts as $s)
        @php $color = $s->WARNA_LABEL ?? '#3B82F6'; @endphp
    <div class="sh-shift-card">
        ...
        <div class="d-flex justify-content-between align-items-start">
            <div>
                ...
                <div class="sh-shift-name mt-1">{{ $s->NAMA_SHIFT }}</div>
            </div>
                    ...
                    <div class="modal-body p-4">
                        <div class="row g-3 text-start">
                            <div class="col-6">
                                ...
                                <input type="text" class="form-control" name="shift_code" value="{{ $s->SHIFT_CODE }}" required>
                            </div>
                            <div class="col-6">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control" name="nama_shift" value="{{ $s->NAMA_SHIFT }}" required>
                            </div>
