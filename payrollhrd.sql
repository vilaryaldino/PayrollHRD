...
--
-- Ketidakleluasaan untuk tabel `t_register_lembur`
--
ALTER TABLE `t_register_lembur`
  ADD CONSTRAINT `FK_LEMBUR_PEGAWAI` FOREIGN KEY (`id_pegawai`) REFERENCES `m_pegawai` (`ID_PEGAWAI`) ON DELETE SET NULL ON UPDATE CASCADE;
COMMIT;
